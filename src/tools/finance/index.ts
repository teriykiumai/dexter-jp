...
export {
  ...
  VOLUME_PROFILE_ALLOCATION_METHOD,
  VOLUME_PROFILE_BIN_COUNT,
  VOLUME_PROFILE_BINNING_METHOD,
  VOLUME_PROFILE_MAXIMUM_BAR_COUNT,
  VOLUME_PROFILE_MINIMUM_BAR_COUNT,
  VOLUME_PROFILE_VALUE_AREA_TARGET,
  volumeProfileConservationTolerance,
  VolumeProfileAllocationInputError,
  VolumeProfileSourceValidationError,
  type VolumeProfileAllocation,
  type VolumeProfileAllocationBar,
  type VolumeProfileAllocationBin,
  type VolumeProfileAllocationInputIssue,
...
export {
  ...
  type FetchVolumeProfileSourceInput,
