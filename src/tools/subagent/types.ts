...
export const SUBAGENT_TYPES: Record<string, SubagentTypeConfig> = {
  ...
  research: {
    ...
    tools: ['web_search', 'x_search', 'web_fetch', 'read_filings', 'get_stock_price', 'get_margin_data', 'get_dividend_summary', 'get_investor_type_flows', 'get_short_sale_reports', 'get_sector_index', 'get_topix'],
    maxIterations: 8,
  },
  analysis: {
    ...
    tools: ['get_financials', 'get_stock_price', 'get_margin_data', 'get_dividend_summary', 'get_investor_type_flows', 'get_short_sale_reports', 'get_sector_index', 'get_topix', 'company_screener', 'read_filings'],
    maxIterations: 8,
  },
};
