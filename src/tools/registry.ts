...
import {
  ...
  ANALYZE_VOLUME_PROFILE_DESCRIPTION,
...
export function getToolRegistry(model: string): RegisteredTool[] {
  ...
  const tools: RegisteredTool[] = [
    ...
    },
    {
      ...
      tool: analyzeVolumeProfileTool,
      description: ANALYZE_VOLUME_PROFILE_DESCRIPTION,
      compactDescription: 'Deterministic daily adjusted-OHLCV volume-profile proxy with POC and contiguous 70% Value Area.',
      concurrencySafe: true,
    },
    {
    ...
    },
    {
      ...
      tool: analyzeSectorBenchmarkTool,
      description: ANALYZE_SECTOR_BENCHMARK_DESCRIPTION,
      compactDescription: 'Deterministic 20/60/250-day stock-versus-as-of TSE 33-sector benchmark statistics.',
      concurrencySafe: true,
    },
    {
      name: 'analyze_sector_short_ratio',
      tool: analyzeSectorShortRatioTool,
      description: ANALYZE_SECTOR_SHORT_RATIO_DESCRIPTION,
      compactDescription: 'Deterministic daily TSE 33-sector short-selling turnover ratios from official source values.',
      concurrencySafe: true,
    },
    {
  ...
  if (isJQuantsAvailable()) {
    tools.push(
      ...
      },
      {
        ...
        tool: getInvestorTypeFlows,
        description: INVESTOR_TYPE_FLOWS_DESCRIPTION,
        compactDescription: 'Weekly market-section investor-type trading values from J-Quants (Light plan or higher).',
        concurrencySafe: true,
      },
      {
      ...
      },
      {
        ...
        tool: getSectorShortRatio,
        description: SECTOR_SHORT_RATIO_DESCRIPTION,
        compactDescription: 'Daily TSE 33-sector short-selling turnover components from J-Quants (Standard plan or higher).',
        concurrencySafe: true,
      },
    );
  }
