...
const ManifestSchema = z.object({ version: z.literal(1), schemaVersion: z.union([z.literal(1), z.literal(2), z.literal(3), z.literal(4), z.literal(5), z.literal(6)]),
...
export function backupWorkspace(root: string, destination: string, codecs: ReferenceCodecs, checkpoint?: PublicationCheckpoint): void {
  ...
  try {
    ...
    const manifest: Manifest = { version: 1, schemaVersion: sourceVersion as Manifest['schemaVersion'], schemaFingerprint: workspaceFingerprint(sourceVersion),
