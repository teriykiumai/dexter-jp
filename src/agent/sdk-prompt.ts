...
- **get_sector_short_ratio** (when available): daily TSE 33-sector short-selling turnover components from J-Quants.
...
- **analyze_sector_short_ratio**: deterministic daily sector short-selling turnover totals and ratios from structured source values.
